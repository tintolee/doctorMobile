  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{marginLeft:100, marginTop:-45}}>
        <Text style={styles.Mainheader}>Withdrawal Type</Text>
      </View>
      <View style={{marginTop:-40, marginLeft:70}}>
      <Text style={{fontSize:16, fontFamily:'satoshi-Medium', color:theme.colors.grey}}>Choose your preffered withdrawal method</Text>
      </View>
